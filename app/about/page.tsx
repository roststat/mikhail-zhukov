...
export const metadata = {
  ...
  description: "Психолог-профайлер, автор и разработчик функциональной модели аффективной системы FASE.",
};

export default function About() {
  const timeline = [
    ["2008","Начало исследований в области психологии личности. Первые попытки создать функциональную модель человека."],
    ["2011","Разработка первой версии модели FASE. Начало практической работы с клиентами."],
    ["2014","Первые научные публикации на платформе P-17. Признание в профессиональном сообществе психологов."],
    ["2017","Оформление авторской методики FASE. Первые корпоративные проекты и работа с командами."],
  ...
  const achievements = [
    "Автор методики FASE",
    "Людям — от выживания к зрелой ответственности",
    "Командам — внутренняя коммуникация без эмоциональных помех",
    "Организациям — системное развитие через понимание человеческого фактора",
    "Образование в области органической химии",
  ];
    ...
    <>
      <div className="page-header">
        <div className="wrap">
          ...
          <h1 className="page-h1 f-display">Психолог.<br /><em style={{color:"var(--gold)"}}>Профайлер.</em><br />Исследователь.</h1>
        </div>
      </div>
      ...
      <section className="section bg-warm">
        <div className="wrap">
          <div className="grid-2">
            <div>
              <span className="tag">Мой подход</span>
              <div className="gold-rule" style={{margin:"12px 0 32px"}}></div>
              <p style={{fontSize:"17px",color:"var(--text)",lineHeight:1.9,marginBottom:"20px"}}>Михаил Жуков — психолог-профайлер, автор и разработчик функциональной модели аффективной системы FASE. Фундаментальное образование в области органической химии научило меня видеть систему там, где другие видят хаос.</p>
              <p style={{fontSize:"17px",color:"var(--text)",lineHeight:1.9,marginBottom:"20px"}}>Тонкий синтез и анализ фармацевтических материалов сформировали структурное мышление, которое я применяю в психологии. Сегодня я помогаю людям, командам и организациям понять внутренние механизмы своей эмоциональной системы и использовать их осознанно.</p>
              <p style={{fontSize:"17px",color:"var(--text)",lineHeight:1.9,marginBottom:"20px"}}>FASE — функциональная модель аффективной системы — это авторский инструмент диагностики и управления эмоциональными реакциями. Она позволяет разложить «стихию чувств» на составляющие, увидеть закономерности и трансформировать непроизвольные реакции в осознанные стратегии.</p>
              <p style={{fontSize:"17px",color:"var(--text)",lineHeight:1.9,marginBottom:"36px"}}>Мы не просто говорим об эмоциях. Мы настраиваем систему так, чтобы она работала на вас. Это позволяет управлять собой, отношениями и бизнес-процессами с той же точностью, с которой химик управляет реакцией в лаборатории.</p>
