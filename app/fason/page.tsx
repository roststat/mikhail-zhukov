...
export default function Fason() {
  ...
  const faqs = [
    ...
    ["Нужна ли специальная подготовка?","Для клиентов — нет. Михаил Жуков работает с широкой аудиторией. Для специалистов, желающих применять методику, есть отдельные форматы обучения."],
  ];
